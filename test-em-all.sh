...
echo "Verify that a normal request works, expect three recommendations and three reviews"
...
echo "Verify that no recommendations are returned for productId 113"
...
echo "Verify that no reviews are returned for productId 213"
