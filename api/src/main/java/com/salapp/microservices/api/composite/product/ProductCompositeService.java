...
public interface ProductCompositeService {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 422, message = "Unprocessable entity, input parameters caused the processing to fail. See reponse")
    })
    ...
    void deleteCompositeProduct(@PathVariable(value = "productId") int productId);
